...
but6.onclick = function () {
    ...
    var newRez4 = rez4.toUpperCase();
    if (newRez4 == 'КОСМИЧЕСКИЙ КОРАБЛЬ') {
        left = left - 100;
        cont.style.left = left + '%';
        color6 = 'green';
...
$('#coo').bind('click',function () {
    ...
    document.cookie = 'error129=' + encodeURIComponent('129') + '; max-age=' + 3156000 + '; path =/';
